...
void Gel() {
  ...
  for (int i=0; i<nentries; i++) {
    ...
    if (e3 >= 1.2e3) {
      ...
      if ((abs(time_2 - time_1) <= 40) &&
          ...
          if (h_time->GetEntries() == 127) break;
        }
    }
  ...
  c2->SaveAs("figures/lifetime/Gel/t1vst2.pdf");
  c2->SaveAs("figures/lifetime/Gel/t1vst2_zoom.pdf");
  c3->SaveAs("figures/lifetime/Gel/lifetime.pdf");
