...
void Distance() {
  ...
  std::string treepath[3] = {"data/dist/137Cs_8cm.root",
                             "data/dist/137Cs_16cm.root",
                             "data/dist/137Cs_24cm.root"},

              figpath[4] = {"figures/distance/8cm.pdf",
                            "figures/distance/16cm.pdf",
                            "figures/distance/24cm.pdf",
                            "figures/distance/scatter.pdf"},
              branchname = "EnergyTrap2",
              treename = {"tree;2"},
              elementname[3] = {"8 cm", "16 cm", "24 cm"};
  double LowLim[3] = {5e3, 5e3, 5e3},
         UpLim[3] = {33e3, 33e3, 33e3},
         fitMin[3] = {26.5e3, 26.5e3, 26.5e3},
         fitMax[3] = {31e3, 31e3, 31e3};
